...
var _capacity_multiplier: float = DEFAULT_CAPACITY_MULTIPLIER
...
func set_capacity_multiplier(multiplier: float) -> bool:
	...
	_capacity_multiplier = multiplier
	return true


func get_configured_capacity() -> float:
	return maxf(_definition.base_processing_rate * _capacity_multiplier, 0.0)
...
func get_save_data() -> Dictionary:
	return {
		"enabled": _enabled,
		"capacity_multiplier": _capacity_multiplier,
	}
